...
const switchColors: Record<ColorType, string> = {
  ...
  'dark/white':
    '[--switch-bg-ring:theme(colors.zinc.950/90%)] [--switch-bg:theme(colors.zinc.900)] dark:[--switch-bg-ring:transparent] dark:[--switch-bg:theme(colors.white)] [--switch-ring:theme(colors.zinc.950/90%)] [--switch-shadow:theme(colors.black/10%)] [--switch:white] dark:[--switch-ring:transparent] dark:[--switch:theme(colors.zinc.900)]',
...
export function Switch({ color = 'dark/zinc', className, ...props }: SwitchProps) {
  return (
    <HeadlessSwitch data-slot="control" className={clsx(className, baseStyles.container)} {...props}>
